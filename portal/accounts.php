                ...
                <div class="card-box pd-10 height-100-p mb-30">
                    <div class="row align-items-center">
						...
						<div class="alert alert-info alert-dismissible fade show">
							<h5 style='color:#7F0253;'>Accounting & BookKeeping Service <br></h5> <i>Support multiple file upload</i>
						</div>
							<section style='padding:10px;'>
								...
								<form action="<?php echo $_SERVER['PHP_SELF']."?id=".$_GET['id']; ?>" method = "POST" class="tab-wizard2 wizard-circle wizard" enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box">
												<input type="file" name="bank_statement[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box">
												<input type="file" name="inv_rept[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box">
												<input type="file" name="exp_rept[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box">
												<input type="file" name="payroll_detail[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box">
												<input type="file" name="invest_detail[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<div class="input-box" > 
												<input type="file" name="loan_detail[]" multiple>
											</div>
										</div>
									</div>
									<div class="form-group row">
