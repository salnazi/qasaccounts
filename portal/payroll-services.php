							...
							<section style='padding:10px;'>
								...
								<form action="<?php echo $_SERVER['PHP_SELF']."?id=".$_GET['id']; ?>" method = "POST" class="tab-wizard2 wizard-circle wizard" enctype="multipart/form-data">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label" style='color:#3B3B3B;font-weight:bold;'>Hourly, Daily & Monthly calculation of Staff payroll sheet Calculation of Overtime, Incentives, and commission for staff. Supporting in the creation of SIF files for WPS salary transfer as per UAE Labor Law requirement.</label>
										<div class="col-sm-8">
											<div class="input-box">
